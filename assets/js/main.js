...
// Find where grecaptcha is being used and wrap it in a check
if (typeof grecaptcha !== 'undefined') {
    grecaptcha.ready(function() {
        // Your existing reCAPTCHA code here
    });
}

// Fix jQuery easing
$(document).ready(function() {
    // Set default easing if not already set
    if (!$.easing.def) {
        $.easing.def = 'swing';
    }
    
    // Add basic easing functions if needed
    $.extend($.easing, {
...
$(document).ready(function() {
    // Initialize cookie notice if the function exists
    if (typeof gdprCookieNotice !== 'undefined') {
        gdprCookieNotice({
            ...
            implicit: true,
            statement: 'https://yoursite.com/privacy',
